...
.logo .en{font-family:'Marcellus',serif;font-size:24px;letter-spacing:.07em}
...
<header>
  <div class="wrap hd">
    <a href="index.html" class="logo" aria-label="효성중전기 홈">
      <span class="en">HYOSUNG</span>
      <span class="sub">HEAVY ELECTRIC</span>
    </a>
    <nav class="gnb" aria-label="주 메뉴">
      <ul>
        ...
        <li><a href="product-gm.html" class="${active==='gb'||active==='gm'?'on':''}">기어드모터</a>
...
<script>window.sb=(window.SB_URL&&window.SB_KEY)?window.supabase.createClient(window.SB_URL,window.SB_KEY):null;</script>`;
...
<script src="supabase-config.js"></script>
<script>
const sb=(window.SB_URL&&window.SB_KEY)?window.supabase.createClient(window.SB_URL,window.SB_KEY):null;
