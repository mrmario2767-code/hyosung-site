...
const OUT = '/home/user/hyosung/site/light';
...
@media(max-width:960px){
 ...
 .hd .cta-btn{padding:8px 15px;font-size:12.5px;box-shadow:none}
 .logo .en{font-size:18px}
 .logo .he{font-size:7.5px;gap:2px;letter-spacing:.18em}
 .logo .kr{font-size:10px;margin-top:4px}
...
@media(max-width:760px){
 .phero{padding:46px 0 36px}
 .phero h1{font-size:25px}
 .phero p{font-size:13.5px;margin-top:8px}
 .phero .tag{font-size:11.5px;letter-spacing:.24em}
 .content{padding:32px 0 60px}
 .sec-h{margin:32px 0 12px}
 .sec-h h2{font-size:19px}
 .sec-head h2{font-size:21px}
 .sec-head p{font-size:13.5px}
 .tbl-sec h3{font-size:16px}
 .tbl-sec .desc{font-size:12.5px}
 table.spec{font-size:11.5px}
 table.spec th,table.spec td{padding:5px 7px}
 table.board{font-size:13px}
 table.board th,table.board td{padding:10px 8px}
 .tabs button{font-size:13px;padding:8px 15px}
 .subtabs a,.subtabs button{font-size:11.5px;padding:5px 11px}
 .card{padding:20px 18px}
 .about-lead{font-size:19px!important}
 .dl-card h4{font-size:14.5px}
 .dl-card .meta{font-size:11.5px}
 .info-table{font-size:13px}
 .info-table th{width:88px;padding:10px 4px}
 .info-table td{padding:10px 4px}
 .note-box{font-size:12.5px;padding:12px 14px}
 .cband{padding:40px 0}
 .cband h2{font-size:21px}
 .cband .tel{font-size:28px}
 .cband .sub{font-size:12.5px}
...
<nav class="mnav" id="mnav">
    ...
    <a href="cyclo.html">싸이크로감속기</a>
    <a href="product-transformer.html">변압기</a>
    <a href="data-spec.html">자료실</a>
    <a href="data-spec.html" class="sub">— 사양서</a>
...
<meta property="og:site_name" content="(주)효성중전기">
<meta property="og:title" content="(주)효성중전기 — 전동기 · 기어드모터 · 싸이크로감속기 · 변압기">
<meta property="og:description" content="산업용 동력·전력 설비 전문기업. 고압·저압 전동기, 기어드모터, 싸이크로감속기, 변압기를 정확한 사양으로 공급합니다.">
<meta property="og:image" content="https://hyosung-site.pages.dev/img/og.png">
<meta property="og:url" content="https://hyosung-site.pages.dev/">
...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "@id": "https://hyosung-site.pages.dev/#company",
  "name": "(주)효성중전기",
  "alternateName": "HYOSUNG HEAVY ELECTRIC",
  "url": "https://hyosung-site.pages.dev/",
  "logo": "https://hyosung-site.pages.dev/favicon-192.png",
  "image": "https://hyosung-site.pages.dev/img/og.png",
  "description": "산업용 동력·전력 설비 전문기업. 고압·저압 전동기, 기어드모터, 싸이크로감속기, 변압기를 공급합니다.",
  "telephone": "+82-2-535-1571",
  "email": "hsgearmotor@korea.com",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "신대방1가길 38, 106동 214호 (동작상떼빌)",
    "addressLocality": "동작구",
    "addressRegion": "서울특별시",
    "postalCode": "07072",
    "addressCountry": "KR"
  ...
  "contactPoint": [
    {"@type": "ContactPoint", "telephone": "+82-2-535-1571", "contactType": "sales", "areaServed": "KR", "availableLanguage": "Korean"},
    {"@type": "ContactPoint", "telephone": "+82-10-3125-9666", "contactType": "customer service", "areaServed": "KR", "availableLanguage": "Korean"}
  ],
  "makesOffer": [
    {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "고압전동기"}},
    {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "저압전동기"}},
    {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "기어드모터"}},
    {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "싸이크로감속기"}},
    {"@type": "Offer", "itemOffered": {"@type": "Product", "name": "변압기"}}
  ]
}
</script>
...
*{margin:0;padding:0;box-sizing:border-box}
body{font-family:'Noto Sans KR',sans-serif;color:var(--ink);background:var(--cloud);line-height:1.6;word-break:keep-all}
